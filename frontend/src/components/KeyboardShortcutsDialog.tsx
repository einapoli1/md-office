...
const shortcuts = [
  { category: 'General', items: [
    ...
    { keys: `${mod}+Shift+V`, desc: 'Paste without formatting' },
  ]},
  { category: 'Formatting', items: [
    ...
    { keys: `${mod}+\\`, desc: 'Clear formatting' },
    { keys: `${mod}+Shift+C`, desc: 'Copy formatting' },
    { keys: `${mod}+L`, desc: 'Left align' },
    { keys: `${mod}+E`, desc: 'Center align' },
    { keys: `${mod}+R`, desc: 'Right align' },
    { keys: `${mod}+J`, desc: 'Justify' },
  ]},
  { category: 'Content', items: [
    { keys: `${mod}+Shift+7`, desc: 'Numbered list' },
    { keys: `${mod}+Shift+8`, desc: 'Bullet list' },
    { keys: `${mod}+Shift+L`, desc: 'Bullet list (alt)' },
